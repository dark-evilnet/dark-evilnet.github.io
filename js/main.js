! function() {
    ...
    }), o("click", "#navbar .nav-link", function(e) {
        let t = i(this.hash);
        if (t) {
            e.preventDefault();
            let o = i("#navbar"),
                s = i("#header"),
                l = i("section", !0);
            if (i("#navbar .nav-link", !0).forEach(e => {
            ...
            s.classList.contains("header-top") ? (l.forEach(e => {
                e.classList.remove("section-show")
            }), t.classList.add("section-show")) : (s.classList.add("header-top"), setTimeout(function() {
                l.forEach(e => {
                    e.classList.remove("section-show")
